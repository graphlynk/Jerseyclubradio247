        ...
        >
          ...
          <div className="p-6 border-b border-[#1a0040]">
            <div className="flex items-center gap-3">
              <div className="w-11 h-11 rounded-xl flex items-center justify-center relative overflow-hidden flex-shrink-0">
                <img src={logoImg} alt="Jersey Club Radio 24/7" className="w-full h-full rounded-xl object-contain" style={{ imageRendering: 'auto' }} />
                {isPlaying && (
          ...
          >
            <div className="max-w-5xl mx-auto">
              ...
              <div className="flex items-center justify-between gap-4 mb-6">
                {/* Logo */}
                <div className="flex-shrink-0 w-[60px] h-[60px] rounded-full overflow-hidden" style={{ boxShadow: '0 0 12px rgba(157,0,255,0.3)' }}>
                  <img src={logoImgHQ} alt="JCR" className="w-full h-full object-contain" style={{ imageRendering: 'auto', filter: 'brightness(1.4)' }} />
                </div>
